...
**Answer** The error says: "Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>." This means that the data types are different from each other and incompatible. One of a character data type, and the other is a numeric data type.  
...
**Answer** They have the columns for the demographic data, but all the fields say NA.
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population was 44032. The average of those loans was 53836.46, and the median amount 20000. 
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population was 113937. The average of those loans was 88140.24 and the median was 20833.
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population, grouped by rural status was 148. The average amount was 44328.87, and the median was 19621. For urban status, the amount was 43884. The average amount was 53868.53, and the median was 20000. 
...
**Answer** The number of PPP loans that went to ZCTA with more than 50% non-Hispanic white, population, grouped by rural is 18337. The average amount was 73694.14 and the median was 20833. For urban status, the number is 95600, the average amount is 90911.14 and the median was 20833. 
