...
**Answer** The number of observations is 195,856 and there are 63 variables. 
...
**Answer** The "name" column is possibly the names of businesses or people that applied for a Maryland loan. The "amount" column is possibly the amount of loans each person/business was given. 
...
**Answer** Five companies. They serve BBQ food.
