...
A2: The 5-digit ZIP code that got the largest amount of total loans by dollar value was 25301. They had a total of 160,741,782.88 dollars. The business that got the largest loan in that ZIP code - 25301 - was The Eye and Ear Clinic  of Charleston DBA Charleston Surgical Hospital. Their total loan amount was 1,520,007 dollars. The clinic is located at 1306 Kanawha Blvd, in	Charleston, KANAWHA county. The forgiveness amount comes up as NA, according to the data. Since NA comes up, that means their loan amount is higher than their forgiveness amount (it doesn't exist). The reason for the discrepancy could be that the company never filed for a forgiveness loan application. 
