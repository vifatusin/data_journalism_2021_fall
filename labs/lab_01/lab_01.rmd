...
**A5** The West Virginia business that got the state's largest PPP loan was Independent LLC DBA The Press Room. They got $136,764.70. The data shows that it is a corporation. I also looked it up and it shows an "upscale" American restaurant. I added the "project_city" column in the code to make sure that the cities matched each other when looking up the business. The loan retained 8 jobs.
...
**A6** There isn't a company identified in question 2. There's a company identified in question 5 - Independent LLC DBA The Press Room - but there isn't any information about the owner, Mike Luksa, being a politician. The local newspaper, The Shepherdstown Chronicle, has an article about him and his wife accepting an honorary award from the Shepherdstown Rotary Club. Here's the source:  https://www.shepherdstownchronicle.com/news/local-news/2016/12/30/shepherdstown-rotary-club-honors-mike-and-deb-luksa/. The following link contains a review of the restaurant, which mentions the name of the owner again:  https://www.tripadvisor.com/ShowUserReviews-g59519-d665003-r60177497-The_Press_Room-Shepherdstown_West_Virginia.html 
